    ...
    if ($mid) {
      ...
      if ($row = $res->fetch_assoc()) {
        ...
        foreach ($_SESSION['pos_cart'] as &$item) {
          if ($item['id'] == $row['id']) { $item['qty'] += $qty; $found = true; break; }
        }
        if (!$found) {
...
<body>
  ...
  <div class="layout">
    ...
    <main class="dash-wrap">
      <div class="dash-header"><div class="dash-title">Create New Invoice</div></div>
        ...
        <div style="flex:1;">
          ...
          <div style="max-height:520px; overflow:auto; border:1px solid #eef2f3; padding:10px; border-radius:8px; background:#fff;">
            <table style="width:100%; border-collapse:collapse;">
              <tr style="border-bottom:1px solid #f1f4f6;"><th style="text-align:left; padding:8px">Product</th><th style="text-align:left">Price</th><th>Stock</th><th></th></tr>
              ...
              <?php endwhile; else: ?>
              <tr><td colspan="4" style="text-align:center; padding:18px; color:#777;">No products found.</td></tr>
              <?php endif; ?>
            </table>
          </div>
        </div>
        ...
        <div style="width:360px;">
          <div style="background:#fff; border:1px solid #eef2f3; padding:14px; border-radius:8px;">
            ...
            <div style="max-height:360px; overflow:auto;">
              <?php if (!empty($_SESSION['pos_cart'])): $subtotal=0; foreach($_SESSION['pos_cart'] as $it): $subtotal += $it['price']*$it['qty']; ?>
