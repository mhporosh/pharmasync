...
<aside class="sidebar">
  ...
  <nav class="menu">
    ...
    <button class="menu-item has-sub<?= $purchasesOpen ? ' active' : '' ?>" data-target="purchases-sub" aria-expanded="<?= $purchasesOpen ? 'true' : 'false' ?>"><span><i class="fas fa-shopping-cart"></i></span><span>Purchases</span><i class="fas fa-chevron-down chevron"></i></button>
    ...
    <button class="menu-item has-sub<?= $customersOpen ? ' active' : '' ?>" data-target="customers-sub" aria-expanded="<?= $customersOpen ? 'true' : 'false' ?>"><span><i class="fas fa-user-friends"></i></span><span>Customers</span><i class="fas fa-chevron-down chevron"></i></button>
